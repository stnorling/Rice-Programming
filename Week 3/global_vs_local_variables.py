### Note: Within a function, you don't need a global declaration unless your
# are ASSIGNING to the global variable (e.g. reassigning it to something else).

# You may still access the global variable as much as you like from Within
# any function in the program without global declaration, as long as you are note
