...
class Student:
    ...
    def __init__(self, person, pwd):
        # Below we set the person parameter of our Student object
        # to the person object. In doing this, we can access
        # all of the relevant Person object methods and attributes 
        self.person = person
        self.password = pwd
        self.projects = []
    ...
    def get_name(self):
        # Below is an example of using another class method within
        # a different class to return a given result (full name).
    ...
    def add_project(self, project):
        # Similaraly, using the append method below of the list
        # Class can be done in the Student class, as our projects
        # parameter is of the list type.
