...
def deal():
    global outcome, in_play, deck, dealer_hand, player_hand, score, games_played
...
def stand():
    global dealer_hand, score, in_play, outcome, games_played
...
def draw(canvas):
    ...
    canvas.draw_text('Games won: ' + str(score) + "/" + str(games_played), [400, 80], 24, 'Black')
