...
class Avatar:
    def __init__(self, name, hair, initial_gold):
        ...
        self.carried_gold = initial_gold
        self.buried_gold = 0       
...
# in the Avatar's bag by 10%.
    ...
    def sprinkled_with_fairy_dust(self):
        self.carried_gold = self.carried_gold * 1.10
...
# of gold carried (in bag) and the amount of gold buried (in the ground).
    ...
    def __str__(self):
        return self.name + " who has " + self.hair_color + " hair is carrying " + \
        str(self.carried_gold) + " gold and has " + str(self.buried_gold) + " gold buried in the ground."
